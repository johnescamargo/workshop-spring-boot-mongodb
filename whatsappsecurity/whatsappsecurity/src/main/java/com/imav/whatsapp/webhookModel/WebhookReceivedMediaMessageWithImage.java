...
public class WebhookReceivedMediaMessageWithImage {

	public String object;
	public ArrayList<Entry> entry = new ArrayList<>();

	public WebhookReceivedMediaMessageWithImage() {
	...
	public class Image {
		...
		@Override
		public String toString() {
			return "Image [caption=" + caption + ", mime_type=" + mime_type + ", sha256=" + sha256 + ", id=" + id + "]";
		}
	...
	public class Message {
		...
		@Override
		public String toString() {
			return "Message [from=" + from + ", id=" + id + ", timestamp=" + timestamp + ", type=" + type + ", image="
					+ image + "]";
		}
