...
public class WebhookReceivedTextMessageSecurityNotification {

	public String object;
	public ArrayList<Entry> entry = new ArrayList<>();

	public WebhookReceivedTextMessageSecurityNotification() {
	...
	public String toString() {
		return "WebhookReceivedTextMessage [object=" + object + ", entry=" + entry + "]";
	}
	...
	public class Identity {
		...
		@Override
		public String toString() {
			return "Identity [acknowledged=" + acknowledged + ", created_timestamp=" + created_timestamp + ", hash="
					+ hash + "]";
		}
	...
	public class Message {
		...
		@Override
		public String toString() {
			return "Message [from=" + from + ", id=" + id + ", identity=" + identity + ", text=" + text + ", timestamp="
					+ timestamp + ", type=" + type + "]";
		}
