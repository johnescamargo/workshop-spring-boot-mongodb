...
public class WebhookStatusDelivered {

	private String object;
	private ArrayList<Entry> entry;

	public WebhookStatusDelivered() {

	}

	public WebhookStatusDelivered(String object, ArrayList<Entry> entry) {
		this.object = object;
		this.entry = entry;
	}
	...
	public String toString() {
		return "WebhookStatusDelivered [object=" + object + ", entry=" + entry + "]";
	}
	...
	public class Conversation {
		...
		public Conversation(String id, Origin origin) {
			this.id = id;
			this.origin = origin;
		}
		...
		@Override
		public String toString() {
			return "Conversation [id=" + id + ", origin=" + origin + "]";
		}
